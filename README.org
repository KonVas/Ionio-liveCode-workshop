...
SuperCollider, can be found at this repository (use AYOR and always pay attention to volumes while interactine with the running processes). For more information
