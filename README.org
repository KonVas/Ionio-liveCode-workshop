...
SuperCollider, can be found at this repository (use AYOR and always pay attention to volumes while interacting with the running processes). For more information
